...
# Load the cascade
face_cascade = cv2.CascadeClassifier("D:\\projects\\ML\\gemini\\Nasal-Depth-Detection\\Other\\haarcascade_frontalface_default.xml")
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        nasal_bridge_cascade = cv2.CascadeClassifier("D:\\projects\\ML\\gemini\\Nasal-Depth-Detection\\Other\\haarcascade_eye.xml")
